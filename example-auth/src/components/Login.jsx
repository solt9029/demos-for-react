    ...
    return (
      <div>
        ...
        <form onSubmit={(e) => this.processLogin(e)}>
          <input onChange={(event) => this.setState({ email: event.target.value })} type='email' id='email'  placeholder='Email' />
          <input onChange={(event) => this.setState({ password: event.target.value })} type='password' id='password'  placeholder='Password' />
